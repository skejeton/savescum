...
| Make use of ``test/test.um`` to acquire a file loading prefix.
| Example: ``image.load(test::pfx()+"cute_rabbit.png")``, where ``"cute_rabbit.png"`` is relative to the directory of the test.
